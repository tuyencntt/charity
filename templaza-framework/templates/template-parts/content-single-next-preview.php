            ...
            if ( $prev_post ) {
                ...
                <a class="previous-post" href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>">
                    <p class="uk-flex uk-flex-middle uk-margin-remove-vertical">
                        ...
                        <span class="title"><?php echo esc_html__('Previous Post','charity'); ?></span>
                    </p>
                    <h5 class="uk-margin-remove-vertical"><?php echo wp_kses_post($prev_post->post_title); ?></h5>
                </a>
                <?php
            }
            ?>
            ...
            if ( $next_post ) {
                ...
                <a class="next-post" href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>">
                    <p class="uk-flex uk-flex-middle uk-flex-right uk-margin-remove-vertical">
                        <span class="title"><?php echo esc_html__('Next Post','charity'); ?></span>
                        <span class="uk-margin-small-left uk-visible@s" data-uk-icon="arrow-right"></span>
                    </p>
                    <h5 class="uk-margin-medium-left uk-margin-remove-vertical"><?php echo wp_kses_post($next_post->post_title); ?></h5>
                </a>
                <?php
            }
            ?>
